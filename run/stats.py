...
nt_sequences = []
aa_sequences = []
for root, dirs, files in os.walk(r"C:\Users\idoha\OneDrive\Desktop\Projects\dataset\Hagit's dataset\beta_mixcr"):
    for file in files:
...
n_files = sum(1 for root, dirs, files in os.walk(r"C:\Users\idoha\OneDrive\Desktop\Projects\dataset\Hagit's dataset\beta_mixcr")
    for file in files
        if file.endswith(".txt") and file.split(".")[0][-1].isnumeric())
...
nt = read_nt_sequences(r"C:\Users\idoha\OneDrive\Desktop\Projects\dataset\Hagit's dataset\beta_mixcr")
...
aa = read_aa_sequences(r"C:\Users\idoha\OneDrive\Desktop\Projects\dataset\Hagit's dataset\beta_mixcr")
