...
hyp_gru_unfolding_emb16 = FCEmbedding(hyp_gru, hyp_fc)
model = HypSNN(hyp_gru_unfolding_emb16)

train(model, train_loader, test_loader, model_name='hyp_gru_unfolding_emb16')