...
dsee_rnn_emb3 = M_RNN(length=60, output_dim=3, n_hidden=64)
model = DSEE_Embedding(Twin(dsee_rnn_emb3, metric="L1", rescale=True))

train(model, train_loader, test_loader, model_name='dsee_rnn_emb3')