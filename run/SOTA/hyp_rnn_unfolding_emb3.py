...
hyp_rnn_unfolding_emb3 = FCEmbedding(hyp_rnn, hyp_fc)
model = HypSNN(hyp_rnn_unfolding_emb3)

train(model, train_loader, test_loader, model_name='hyp_rnn_unfolding_emb3')