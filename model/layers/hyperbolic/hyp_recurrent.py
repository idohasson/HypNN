    ...
    def forward(self, X, hidden_states=None):
        ...
        for xi in range(X.size(-2)):
            for layer_i in range(self.num_layers):
                ...
                hidden_state = hidden_forward[layer_i - 1] if layer_i > 0 else expmap0(X.select(-2, xi))
                ...
                if self.bidirectional:
                    ...
                    hidden_state = hidden_backward[layer_i - 1] if layer_i > 0 else expmap0(X.select(-2, -(xi + 1)))
